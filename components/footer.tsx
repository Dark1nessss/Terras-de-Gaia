      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-sm text-white/30 tracking-wider flex items-center gap-2 font-medium">
            &copy; {currentYear} Direto Gaia. Todos os direitos reservados.
          </p>

          <div className="flex items-center gap-3 text-white/40">
            <a href="https://facebook.com" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-[#00a6f0]/10 hover:text-[#00a6f0] hover:border-[#00a6f0]/20 transition-all duration-300">
              <svg
            ...
            <a href="https://instagram.com" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-[#00a6f0]/10 hover:text-[#00a6f0] hover:border-[#00a6f0]/20 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
            ...
            <a href="https://twitter.com" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-[#00a6f0]/10 hover:text-[#00a6f0] hover:border-[#00a6f0]/20 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
            ...
            <a href="https://youtube.com" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-[#00a6f0]/10 hover:text-[#00a6f0] hover:border-[#00a6f0]/20 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
