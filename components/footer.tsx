      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-3 text-white/40">
            ...
            <a href={SOCIAL_LINKS.twitter} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-white/10 hover:text-white hover:border-white/20 transition-all duration-300">
            ...
            <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/[0.03] rounded-xl border border-white/[0.08] hover:bg-[#ee1d52]/10 hover:text-[#ee1d52] hover:border-[#ee1d52]/20 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
