...
export default function ContentHub() {
  return (
    <div className="bg-[#0a0a0a] text-white font-nurom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {news.map((item) => (
              <article key={item.id} className="group cursor-pointer">
                ...
                {/* Title */}
                <h3 className="text-xl md:text-2xl font-black leading-tight group-hover:text-[#00a6f0] transition-colors uppercase italic tracking-tighter">
                  {item.title}
                </h3>
