  ...
  return (
    <div ref={ref} className="relative">
      ...
      <div className="md:hidden pl-10 pb-14">
        <motion.div
          className="absolute left-0 top-2 size-3 rounded-full bg-[#00a6f0] ring-4 ring-[#0a0c10] z-10"
          initial={{ scale: 0 }}
        ...
        >
          <p className="text-[#00a6f0] text-[9px] font-black uppercase tracking-[0.5em] mb-1">{year}</p>
      ...
      <div className="hidden md:grid grid-cols-[1fr_80px_1fr] items-center mb-20">
        ...
        <div className="flex flex-col items-center">
          <motion.div
            className="size-4 rounded-full bg-[#00a6f0] ring-4 ring-[#0a0c10] z-10"
            initial={{ scale: 0 }}
            animate={inView ? { scale: 1 } : { scale: 0 }}
  ...
  return (
    <main className="min-h-screen bg-[#0a0c10] text-white font-nurom overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-end pb-20 pt-40 px-6 border-b border-white/10">
        ...
        {/* Glow */}
        <div className="absolute top-0 left-0 w-[60%] h-[60%] bg-[#00a6f0]/5 blur-[160px] rounded-full pointer-events-none" />
        {/* Dot grid texture */}
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div>
            <motion.h1
              ...
              className="text-[clamp(4rem,15vw,14rem)] font-black uppercase italic leading-[0.82] tracking-tighter text-[#00a6f0] drop-shadow-[0_0_60px_rgba(0,166,240,0.3)]"
            >
              GAIA.
            </motion.h1>
          </div>
          ...
          >
            <p className="md:col-span-5 text-white/80 text-xl md:text-2xl font-black italic uppercase tracking-tight leading-snug border-l-4 border-[#00a6f0] pl-6">
        ...
        >
          ...
          <div className="w-12 h-px bg-white/20 relative overflow-hidden">
            <motion.div
              className="absolute inset-y-0 left-0 w-full bg-[#00a6f0]"
              animate={{ x: ["-100%", "100%"] }}
      ...
      {/* ═══════════════════════════════════════════════════════════
          MARQUEE BAND
      ═══════════════════════════════════════════════════════════ */}
      <div className="border-b border-white/10 py-4 overflow-hidden bg-[#00a6f0]/5">
        <div className="marquee-track flex gap-12 whitespace-nowrap">
          {[...MARQUEE_WORDS, ...MARQUEE_WORDS].map((w, i) => (
            <span key={i} className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 shrink-0 flex items-center gap-12">
              {w}
              <span className="size-1 bg-[#00a6f0] rounded-full" />
            </span>
          ))}
        </div>
      </div>
      ...
      <section className="relative py-32 px-6 border-b border-white/10">
        <div className="container mx-auto">
          ...
          <Reveal className="flex items-center gap-6 mb-20">
            ...
            <div>
              <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-2">Capítulo Um</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <Reveal delay={0.1} className="relative">
              <span className="absolute -top-4 -left-2 text-[11rem] font-black leading-none select-none pointer-events-none text-[#00a6f0]/8">&ldquo;</span>
              <blockquote className="relative text-4xl md:text-5xl lg:text-6xl font-black uppercase italic leading-[0.85] tracking-tighter">
                ...
                com um <span className="text-[#00a6f0]">papel.</span>&rdquo;
              </blockquote>
            </Reveal>
          ...
          <div className="mt-24 pt-12 border-t border-white/5">
            <Reveal>
              <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-16">Uma trajetória</p>
            </Reveal>
            <div className="relative">
              {/* Vertical line — mobile */}
              <div className="absolute left-1.5 top-0 bottom-0 w-px bg-white/5 md:hidden" />
              <DrawLineV className="absolute left-1.5 top-0 bottom-0 w-px bg-[#00a6f0]/30 md:hidden" />
              {/* Vertical line — desktop */}
              <div className="absolute left-1/2 -translate-x-px top-0 bottom-0 w-px bg-white/5 hidden md:block" />
              <DrawLineV className="absolute left-1/2 -translate-x-px top-0 bottom-0 w-px bg-[#00a6f0]/30 hidden md:block" />
              {TIMELINE.map((t, i) => (
      ...
      <section className="relative py-32 px-6 border-b border-white/10 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <Reveal className="flex items-center gap-6 mb-16">
            ...
            <div>
              <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-2">Capítulo Dois</p>
          ...
          <Reveal delay={0.15}>
            <p className="text-[clamp(2rem,5vw,5.5rem)] font-black uppercase italic leading-[0.88] tracking-tighter max-w-6xl">
              ...
              <span className="text-[#00a6f0] drop-shadow-[0_0_40px_rgba(0,166,240,0.5)]">qualidade.</span>{" "}
              Gratuita.{" "}
              Acessível.{" "}
              Para todos os que vivem e respiram{" "}
              <span className="relative inline-block">
                <span className="relative z-10">Gaia.</span>
                <span className="absolute bottom-1 left-0 right-0 h-1 bg-[#00a6f0]" />
              </span>
            </p>
          </Reveal>
          ...
          <RevealStagger className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={v.label} variants={fadeUp} className="group pl-6 border-l-2 border-white/10 hover:border-[#00a6f0] transition-colors duration-500 py-4">
                <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-widest mb-4">{v.label}</p>
          ...
          <RevealStagger className="grid grid-cols-2 lg:grid-cols-4 gap-0 divide-x divide-white/5">
            {STATS.map((s) => (
              <motion.div key={s.label} variants={fadeUp} className="group px-8 py-10 text-center hover:bg-white/2 transition-colors">
                <p className="text-6xl md:text-7xl font-black italic text-[#00a6f0] tracking-tighter leading-none mb-3">
                  {s.number}
                </p>
      ...
      <section className="py-24 px-6 border-b border-white/10 bg-[#0d0f14]">
        <div className="container mx-auto">
          <Reveal className="flex items-center gap-6 mb-16">
            <div>
              <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-2">Multiplataforma</p>
            ...
            {PLATFORMS.map((p) => {
              ...
              return (
                <motion.div key={p.label} variants={fadeUp}>
                  <Link href={p.href} className="group relative flex flex-col bg-white/3 border border-white/5 hover:border-[#00a6f0]/50 p-8 transition-all duration-500 hover:bg-[#00a6f0]/5 overflow-hidden h-full">
                    <div className="absolute top-0 right-0 size-20 bg-[#00a6f0]/5 rounded-bl-full group-hover:bg-[#00a6f0]/10 transition-colors duration-500" />
                    <PIcon size={26} className="text-[#00a6f0]/50 group-hover:text-[#00a6f0] transition-colors duration-500 mb-6 shrink-0" />
                    ...
                    <ArrowRight size={14} className="mt-6 opacity-0 group-hover:opacity-100 text-[#00a6f0] transition-all duration-500 group-hover:translate-x-1" />
                  </Link>
                </motion.div>
              );
            })}
      ...
      <section className="border-b border-white/10">
        <div className="container mx-auto px-6 pt-32 pb-16">
          <Reveal className="flex items-center gap-6">
            ...
            <div>
              <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-2">Capítulo Três</p>
          ...
          return (
            <Reveal key={s.num} delay={i * 0.06}>
              <div className={`group relative border-t border-white/5 py-20 md:py-28 overflow-hidden cursor-default`}>
                ...
                <span className={`absolute ${isEven ? '-right-6 bottom-0' : '-left-6 bottom-0'} text-[clamp(10rem,22vw,20rem)] font-black italic text-white/3 leading-[0.8] select-none pointer-events-none translate-y-1/4 group-hover:text-[#00a6f0]/6 transition-colors duration-700`}>
                  {s.num}
                </span>

                {/* Sweep fill — alternates direction */}
                <div className={`absolute inset-0 bg-[#00a6f0]/4 ${isEven ? '-translate-x-full' : 'translate-x-full'} group-hover:translate-x-0 transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]`} />

                {/* Bottom accent line — alternates origin */}
                <div className={`absolute bottom-0 left-0 right-0 h-px bg-[#00a6f0] scale-x-0 group-hover:scale-x-100 ${isEven ? 'origin-left' : 'origin-right'} transition-transform duration-700`} />
                  ...
                  <div className={`flex ${isEven ? 'justify-start' : 'justify-end'}`}>
                    <div className={`max-w-3xl w-full ${!isEven ? 'text-right' : ''}`}>
                      ...
                      <div className={`flex items-center gap-4 mb-6 ${!isEven ? 'justify-end' : ''}`}>
                        <ServiceIcon size={20} className="text-[#00a6f0]/50 group-hover:text-[#00a6f0] transition-colors duration-500 shrink-0" />
                        <span className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.5em]">{s.num}</span>
                        <div className="w-8 h-px bg-white/20" />
                        <span className="text-white/30 text-[10px] font-black uppercase tracking-[0.3em]">{s.sub}</span>
                      </div>

                      {/* Oversized title */}
                      <h3 className="text-[clamp(2.8rem,6vw,7.5rem)] font-black uppercase italic leading-[0.88] tracking-tighter mb-8 group-hover:text-[#00a6f0] transition-colors duration-500">
                        {s.title}
                      </h3>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-225 h-125 bg-[#00a6f0]/8 blur-[160px] rounded-full -translate-y-1/3" />
        </div>
        <div className="container mx-auto relative z-10">

          <Reveal>
            <p className="text-[#00a6f0] text-[10px] font-black uppercase tracking-[0.6em] mb-8">Faça Parte</p>
          ...
          <Reveal delay={0.15} className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-white/10 pt-12">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/contacto">
                  <button className="group bg-[#00a6f0] text-white px-8 py-4 font-black uppercase italic tracking-widest text-sm flex items-center gap-3 hover:bg-white hover:text-black transition-all cursor-pointer">
                    Contactar <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                  </button>
                </Link>
                <Link href="/vira-parceiro">
                  <button className="group border border-white/20 text-white px-8 py-4 font-black uppercase italic tracking-widest text-sm flex items-center gap-3 hover:border-[#00a6f0] hover:text-[#00a6f0] transition-all cursor-pointer">
            ...
            <div className="space-y-0">
              {[
                ...
                <div key={c.label} className="group border-b border-white/5 hover:border-[#00a6f0]/40 transition-colors py-6 flex items-center gap-5 cursor-pointer">
                  <span className="text-white/20 group-hover:text-[#00a6f0] transition-colors">{c.icon}</span>
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-widest text-white/30 mb-1">{c.label}</p>
                    {c.href ? (
                      <a href={c.href} className="text-xl font-bold italic uppercase tracking-tighter group-hover:text-[#00a6f0] transition-colors">{c.value}</a>
                    ) : (
