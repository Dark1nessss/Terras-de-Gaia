...
export default function ProgramsPage() {
  ...
  return (
    <main className="bg-[#0a0c10] min-h-screen font-nurom text-white selection:bg-[#006ec2]">
      ...
      <section className="relative h-[100dvh] w-full overflow-hidden flex items-end pb-24">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[#006ec2]/5 mix-blend-overlay z-10" />
        </div>
            ...
            {featuredProgram && (
              ...
              >
                <div className="flex items-center gap-4">
                  <span className="bg-[#006ec2] text-white text-[10px] font-black px-3 py-1 uppercase tracking-[0.3em] rounded-sm">
                ...
                <div className="flex flex-wrap gap-6 pt-4">
                  <Link href={`/gaia-play/${featuredProgram.slug}`}>
                    <button className="bg-white text-black px-12 py-5 font-black uppercase italic tracking-widest text-xs flex items-center gap-4 hover:bg-[#006ec2] hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-2xl cursor-pointer">
      ...
      <section className="py-32 relative z-30 bg-[#0a0c10]">
        <div className="container mx-auto px-6 mb-12 flex items-end justify-between">
          <div className="space-y-2">
            <span className="text-[#006ec2] text-[10px] font-black uppercase tracking-[0.5em]">Originais</span>
        ...
        <div className="flex w-full h-[450px] md:h-[550px] overflow-x-auto no-scrollbar px-6 md:px-[5%] gap-2 group/list">
              ...
              <Link href={`/gaia-play/${prog.slug}`} className="group block size-full relative">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="h-0.5 w-0 group-hover:w-full bg-[#006ec2] transition-all duration-700" />
          ...
          <Link href="/gaia-play/todos" className="min-w-[300px] h-full flex flex-col items-center justify-center bg-white/5 border border-dashed border-white/10 hover:bg-[#006ec2]/10 hover:border-[#006ec2]/40 transition-all duration-300 gap-4 group">
            <MonitorPlay className="text-white/20 group-hover:text-[#006ec2] transition-colors" size={40} />
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40 group-hover:text-[#006ec2] transition-colors">Ver Tudo</span>
            <ArrowRight size={16} className="text-white/10 group-hover:text-[#006ec2] group-hover:translate-x-1 transition-all" />
          </Link>
        </div>

        {/* Dica de Navegação */}
        <div className="container mx-auto px-6 mt-12 flex items-center gap-4">
           <div className="h-px w-20 bg-[#006ec2]" />
      ...
      <section className="py-24 bg-[#0a0c10] relative border-t border-white/5">
        <div className="container mx-auto px-6">
          ...
          <div className="flex items-end justify-between mb-16">
            <div className="space-y-2">
              <span className="text-[#006ec2] text-[10px] font-black uppercase tracking-[0.5em]">Explorar</span>
              <h2 className="text-5xl md:text-6xl font-black uppercase italic tracking-tighter text-white">
                Browse por <span className="text-transparent outline-text-vibrant">Categoria</span>
              </h2>
            </div>
            <Link href="/programacao" className="hidden md:flex items-center gap-2 text-white/40 hover:text-[#006ec2] transition-colors text-xs font-black uppercase tracking-widest">
            ...
            return (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {categories.map(([cat, progs], i) => (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <Layers size={20} className="text-[#006ec2]" />
                      <ArrowRight size={16} className="text-white/20 group-hover:text-[#006ec2] group-hover:translate-x-1 transition-all" />
                    </div>
                ...
                <motion.div
                  whileHover={{ y: -4 }}
                  transition={{ duration: 0.3 }}
                  className="group relative border border-dashed border-[#006ec2]/30 hover:border-[#006ec2] bg-[#006ec2]/5 hover:bg-[#006ec2]/10 transition-all duration-300 p-8 flex flex-col justify-between cursor-pointer"
                >
                  <Link href="/live" className="absolute inset-0 z-10" aria-label="Conteúdo On Demand" />
                  <Tv size={24} className="text-[#006ec2]" />
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#006ec2]/60 mb-2">Gaia Play</p>
                    <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-4">Conteúdo On Demand</h3>
                    <span className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#006ec2] group-hover:gap-4 transition-all">
