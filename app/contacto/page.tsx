      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative mb-24">
          <motion.span 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-[#006ec2] text-xs font-black uppercase tracking-[0.8em] mb-5 block"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-white/10 pt-12">
          ...
          <div className="lg:col-span-4 space-y-12">
            <a href={`mailto:${CONTACT_INFO.email}`} className="group cursor-pointer">
              <p className="text-[#006ec2] text-[10px] font-black uppercase tracking-widest mb-4">Redação e Geral</p>
              <div className="flex items-center gap-4 border-b border-white/5 pb-6 mb-6 group-hover:border-[#006ec2] transition-colors">
                <Mail className="text-white/20 group-hover:text-[#006ec2]" size={20} />
            ...
            <a href={`tel:${CONTACT_INFO.phone.replace(/\s/g, '')}`} className="group cursor-pointer">
              <p className="text-[#006ec2] text-[10px] font-black uppercase tracking-widest mb-4">Linha Direta</p>
              <div className="flex items-center gap-4 border-b border-white/5 pb-6 group-hover:border-[#006ec2] transition-colors">
                <Phone className="text-white/20 group-hover:text-[#006ec2]" size={20} />
                <span className="text-2xl font-bold italic uppercase tracking-tighter group-hover:pl-2 transition-all">
                  {CONTACT_INFO.phone}
                </span>
              </div>
          ...
          <div className="lg:col-span-8">
            <div className="flex flex-col">
              ...
              <a href={OFFICIAL_PROFILES.instagram} target="_blank" className="group relative py-10 border-b border-white/5 flex items-center justify-between overflow-hidden">
                <div className="flex items-center gap-8 relative z-10 flex-1 min-w-0 max-w-[52%] lg:max-w-none">
                  <span className="text-white/10 group-hover:text-[#006ec2] font-black italic text-2xl transition-colors shrink-0">01</span>
                  <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic uppercase tracking-tighter group-hover:translate-x-4 transition-transform duration-500">
                    Instagram
                  </h2>
                </div>
                <div className="flex items-center gap-4 relative z-10 shrink-0 group-hover:-translate-x-4 transition-transform duration-500">
                   <span className="hidden md:block text-xs font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 text-right">Seguir<br />@TerrasdeGaia</span>
                   <div className="p-4 bg-white/5 rounded-full group-hover:bg-[#006ec2] transition-colors">
              ...
              <a href={OFFICIAL_PROFILES.facebook} target="_blank" className="group relative py-10 border-b border-white/5 flex items-center justify-between overflow-hidden">
                <div className="flex items-center gap-8 relative z-10 flex-1 min-w-0 max-w-[52%] lg:max-w-none">
                  <span className="text-white/10 group-hover:text-[#006ec2] font-black italic text-2xl transition-colors shrink-0">02</span>
                  <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic uppercase tracking-tighter group-hover:translate-x-4 transition-transform duration-500">
                    Facebook
                  </h2>
                </div>
              ...
              <a href={OFFICIAL_PROFILES.youtube} target="_blank" rel="noopener noreferrer" className="group relative py-10 border-b border-white/5 flex items-center justify-between overflow-hidden">
                <div className="flex items-center gap-8 relative z-10 flex-1 min-w-0 max-w-[52%] lg:max-w-none">
                  <span className="text-white/10 group-hover:text-[#006ec2] font-black italic text-2xl transition-colors shrink-0">03</span>
                  <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic uppercase tracking-tighter group-hover:translate-x-4 transition-transform duration-500">
                    YouTube
                  </h2>
                </div>
                <div className="flex items-center gap-4 relative z-10 shrink-0 group-hover:-translate-x-4 transition-transform duration-500">
                  <span className="hidden md:block text-xs font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 text-right">Subscreva<br />@TerrasdeGaia</span>
              ...
              <a href={OFFICIAL_PROFILES.tiktok} target="_blank" rel="noopener noreferrer" className="group relative py-10 flex items-center justify-between overflow-hidden">
                <div className="flex items-center gap-8 relative z-10 flex-1 min-w-0 max-w-[52%] lg:max-w-none">
                  <span className="text-white/10 group-hover:text-[#006ec2] font-black italic text-2xl transition-colors shrink-0">04</span>
                  <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black italic uppercase tracking-tighter group-hover:translate-x-4 transition-transform duration-500">
                    TikTok
                  </h2>
                </div>
